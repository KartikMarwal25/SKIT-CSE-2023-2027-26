 ...
 * Base32 chars>` (DP-01). It is generated API-side; the database's unique
 * constraint on certificate_number is the actual source of truth for
 * collision-freedom — this module only makes collisions rare (~60 bits of
 * CSPRNG entropy in the 12-char suffix).
 */
 ...
 * violation up to a small number of attempts (wired in once the issuance
 * service lands, Week 6).
 *
 ...
 * @returns {string} A candidate certificate number.
